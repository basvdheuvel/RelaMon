...
// Axios is a Node.js package that is used to make HTTP requests to the monitor
...
// The address of the service's monitor
...
// Wait for POST requests on the root ('/') path: messages from the monitor
app.post("/", (req, res) => {
	res.end();
	switch(state){
        case 1:
